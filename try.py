...
if __name__ == '__main__':
    cap = cv2.VideoCapture("/home/shiraz/Downloads/4shiraz/09_45_30_cam_Pillar_RGB.mp4")
    ...
    while (cap.isOpened):
        ...
        for box in bbox:
            ...
            right_Belt = points[12][:2]
            right_Belt = [int(w) for w in right_Belt]

            left_Belt = points[11][:2]  
            ...
            cv2.circle(frame, center=tuple(right_Belt), radius=4, color=(0, 0, 0), thickness=6)
